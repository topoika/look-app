...
class BankAccountDeposit extends StatefulWidget {
  ...
  const BankAccountDeposit({Key? key,required this.points,required this.bigEventPoints}) : super(key: key);
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Form(
                            ...
                            child: TextFormField(
                              ...
                              decoration: const InputDecoration(
                                hintText: "      Please enter the depositor name",
                         ...
                         Padding(
                          ...
                          child: Text('\nPlease Enter the depositor name. If you do not deposit the correct amount or if the '
                              'depositor name is different, the point charging may be delayed',style: TextStyle(fontFamily: 'PopB',fontSize: w*0.04),),
                        ),
                        ...
                        Center(
                          ...
                          child: InkWell(
                              ...
                              child: Text("   Confirm   ",textAlign: TextAlign.center,style: TextStyle(color:Colors.white,fontWeight:FontWeight.bold,fontSize: w*0.05),)),
                          ),
                        ),
                      ],
                    ),
...
Widget price(int p,double w)
{
  ...
  switch(p){
    case 300:
      return Text('\n (\$4.9)\n',style: TextStyle(color:Colors.red,fontWeight:FontWeight.bold,fontSize: w*0.06),);
    case 450:
  return Text('\n (\$4.9)\n',style: TextStyle(color:Colors.red,fontWeight:FontWeight.bold,fontSize: w*0.06),);
    case 600:
      return Text('\n (\$9.1)\n',style: TextStyle(color:Colors.red,fontWeight:FontWeight.bold,fontSize: w*0.06),);
